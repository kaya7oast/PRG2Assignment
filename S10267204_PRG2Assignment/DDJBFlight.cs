...
namespace S10267204_PRG2Assignment
{
    ...
    {
        public DDJBFlight(string flightNumber, string origin, string destination, DateTime expectedTime, string status = "Null") : base(flightNumber, origin, destination, expectedTime, status) { }
